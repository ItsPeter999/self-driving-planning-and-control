...
%syms sf sr;%分别为前后车轮的滑移率,需要提供***************需修改
Sf=0.2; Sr=0.2;
%syms a b;%前后车轮距离车辆质心的距离，车辆固有参数***************需修改
a=1.265;b=1.682;
%syms C_cf C_cr C_lf C_lr;%分别为前后车轮的纵横向侧偏刚度，车辆固有参数***************需修改
Ccf=175016;Ccr=130634;Clf=175016;Clr=130634;
%syms m g I;%m为车辆质量，g为重力加速度，I为车辆绕Z轴的转动惯量，车辆固有参数***************需修改
m = 2020;
g=9.8;
I=4095;
